...
import { loginRequest } from '../services/candidateRequest'
    ...
    <div>
      ...
      <div className='flex justify-center m-4'>
       ...
       <div className="w-3/3 max-w-[500px]  m-4 p-4 bg-[#2e2e2e] rounded-xl " >
            <p className="text-4xl text-amber-300 mb-4 text-center ">Signup </p>
             ...
             <div className='flex  justify-center mx-4 flex-col'>
              ...
              <div onClick={handleSignup} className=" text-center self-center mt-6 p-1 w-4/4  rounded-lg bg-amber-400 text-black font-semibold " > Submit</div>
             </div>
