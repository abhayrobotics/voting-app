...
function App() {
  ...
  const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4YmM3NGQ2MjIzYTZjMjQyMjhlYzYxZiIsImlhdCI6MTc1NzI3Nzg0OX0.bKcmJo7NIvqLalJH71KplVuCA-1TbU0pVL11CqQiFQI"
  const payload = {
    "name": "Akhilesh Yadav",
    "party": "RJD",
    "age": 66
  ...
  return (
    <>
      ...
      <diV onClick= {()=>addCandidate(payload)}> Add Candidate</diV>
    </>
  )
}
